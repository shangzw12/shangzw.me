<?php 
    ...
    function display_comment_btm($row,$name){
		...
		<div class='col-md-3'>
			<p> <a href='##'><span class='glyphicon glyphicon-heart-empty' aria-hidden='true'></span></a>$row[like_num] </p>
		</div>
        <div class='col-md-2'>
			<p> <a href='##'><span class='glyphicon glyphicon-music' aria-hidden='true'></span></a>$row[like_num] </p>
		</div>
        ";
    }
    function display_saying($row, $head_pic, $name){
		...
		<div class='col-md-11'>
			<div class='row'>
				<div class = 'col-md-12'> <p><a href='##'> $name </a></p> </div>
